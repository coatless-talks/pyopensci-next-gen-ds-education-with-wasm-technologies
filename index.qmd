...
> 
> — [Frank Oppenheimer](https://en.wikipedia.org/wiki/Exploratorium#History) in ["Exploratorium"](https://www.exploratorium.edu/video/exploratorium-jon-boorstin) by Jon Boorstin (1974) at ~13:22
...
[Me in ~2018](https://twitter.com/axiomsofxyz/status/999487130463277056) thinking [`learnr`](https://rstudio.github.io/learnr/articles/formats.html) + **Shiny Server** + 100 students = 😱
...
```{.yaml code-line-numbers="6-8,11-12"}
---
format: 
    live-revealjs:
        scrollable: true
